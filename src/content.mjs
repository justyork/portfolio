...
export const languages = {
  en: {
    ...
    writingTitle: 'Writing / notes',
    writingText: 'Planned: concise notes about architecture, AI-assisted development, reliability and engineering leadership.',
    contactTitle: 'Contact',
    contactText: 'Open to relevant technical leadership, architecture, AI systems and product engineering conversations.',
    labels: {
  ...
  ru: {
    ...
    writingTitle: 'Writing / заметки',
    writingText: 'План: короткие заметки про архитектуру, AI-assisted development, reliability и engineering leadership.',
    contactTitle: 'Контакты',
    contactText: 'Открыт к релевантным разговорам про technical leadership, architecture, AI systems и product engineering.',
    labels: {
...
export const experience = [
  ...
  { company: 'WebYard Studio', role: 'Lead Full Stack Developer', dates: 'Sep 2013 — May 2020', location: 'Irkutsk Region, Russia', summary: 'Led two web development teams; maintained 10+ loaded projects and dozens of websites.' },
