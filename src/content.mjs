...
export const languages = {
  en: {
    ...
    description: 'Technical Architect and AI System Builder with dynamicExperience years in software engineering, AI-assisted systems, agentic workflows, automation, high-load platforms and data pipelines.',
    nav: ['Profile', 'Expertise', 'Services', 'Case Studies', 'Experience', 'CV', 'Contact'],
    heroKicker: 'Technical Architect & AI System Builder',
    heroTitle: 'I design reliable systems, AI-assisted workflows and data platforms.',
    ...
    about: [
      ...
      'My engineering focus is backend and full-stack development with PHP, Node.js, Go, Python and C#, plus databases, distributed systems, data pipelines and AI-assisted engineering workflows. I have delivered large-scale data migrations, ML-driven content search and recommendation services, AI/automation workflows and frameworks that improve release confidence and system reliability.',
    ...
    servicesTitle: 'Services I can provide',
    servicesIntro: 'Focused, practical help for teams that need architecture, AI-enabled automation and reliable delivery — from discovery to production rollout.',
...
export const proofPoints = {
  en: [
    ...
    'AI agents, automation and ML-driven search',
...
export const expertise = {
  en: [
    ...
    { title: 'AI systems & automation', items: ['AI agents', 'Agent orchestration', 'LLM-assisted development', 'Prompt/context engineering', 'RAG-ready knowledge workflows', 'AI workflow automation', 'Human-in-the-loop review', 'Evaluation and guardrails'] },
    { title: 'Data, search & AI-adjacent systems', items: ['PostgreSQL', 'BigQuery', 'Apache Airflow', 'OpenSearch', 'Data pipelines', 'Image similarity search', 'Recommendation services', 'Search relevance evaluation', 'Semantic search'] },
...
export const serviceOfferings = {
  en: [
    { title: 'AI workflow automation', text: 'Design and implementation of practical AI-assisted workflows: task routing, context preparation, draft generation, review gates and integration with existing tools.' },
    { title: 'Agentic development systems', text: 'Multi-agent operating models for software teams: source-of-truth knowledge base, runtime handoff, Git-based validation, reproducible commands and safe staging-to-production boundaries.' },
    { title: 'AI-ready knowledge bases', text: 'Structuring documentation, decision logs and project state so AI tools can use reliable context instead of scattered chats and tribal knowledge.' },
    { title: 'Search and recommendation systems', text: 'Backend architecture for content tagging, semantic/image similarity search, OpenSearch relevance evaluation and recommendation workflows.' },
    { title: 'Architecture audit and technical leadership', text: 'Assessment of platform boundaries, reliability risks, data flows, API contracts, release process, observability and team delivery model.' },
...
export const experience = [
  { company: 'X-FLOW', role: 'Technical Lead', dates: 'Jun 2023 — Present', location: 'Cyprus', summary: 'Architecture, AI-assisted workflows, release governance, multitenancy, consent management, data pipelines, ML-driven search/recommendation, SLO/SLI and incident command.' },
